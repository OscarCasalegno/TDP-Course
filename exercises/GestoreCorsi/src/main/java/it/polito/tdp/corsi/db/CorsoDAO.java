...
public class CorsoDAO {
    ...
    public Map<Corso, Integer> getIscrittiByPeriodo(Integer pd) {
        String sql = "SELECT c.codins, c.nome, c.crediti, c.pd, COUNT(*) AS tot "
                + "FROM corso AS c, iscrizione as i " + "WHERE c.codins=i.codins AND c.pd = ? "
    ...
    public List<Studente> getStudentiByCorso(Corso corso) {
        ...
        String sql = "SELECT s.matricola, s.nome, s.cognome, s.CDS "
                ...
                + "WHERE s.matricola=i.matricola AND i.codins= ? " + "GROUP BY s.matricola";
    ...
    public Map<String, Integer> getDivisioneCDS(Corso c) {
        ...
        String sql = "SELECT s.CDS, COUNT(*) AS tot " + "FROM studente AS s, iscrizione AS i "
                + "WHERE s.matricola=i.matricola AND i.codins= ? " + "GROUP BY s.CDS ";
