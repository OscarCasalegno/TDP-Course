...
public class FXMLController {
	...
	public void setModel(Model model) {
		...
		this.boxCategoria.setItems(FXCollections.observableArrayList(this.model.listAllOffenseCategoryId()));
		this.boxMese.setItems(FXCollections.observableArrayList(this.model.listAllMonths()));
